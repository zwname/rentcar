...
<div class="main">
    <div>
        <h4 class="page-title" style="display: inline-block">车辆类型修改</h4>
    </div>
    <div class="panel">
        <div class="panel-body">
            <form class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="hidden" id="cateid" value="${cate.cateid }">
                        <input type="text" class="form-control" id="type" value="${cate.catename }">
                    </div>
                </div>
                <div class="form-group">
...
function addCate(){
	layer.confirm('确定要保存？', {
   	 ...
   	 // 点击确定后执行的功能
			$.ajax({
				url:"<%=request.getContextPath()%>/updateCate",
				cache: false,
	           type:'post',
	           data: {
	        	   cateid:$("#cateid").val(),
